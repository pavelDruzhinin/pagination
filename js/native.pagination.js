...
function Pagination(divId, options) {
    ...
    function init(divId, options) {
        ...
        if (options === undefined || options.totalpages === undefined || options.totalpages <= 1)
            return;
    ...
    //End: Create docElements

    //Start: Manipulate domElements
    ...
    //End: Manipulate domElements


    //Start: Actions Start, Numbers, End
